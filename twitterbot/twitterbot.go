...
func New(log *logrus.Logger, track ...string) (*TwitterBot, error) {
	...
	if consumerKey == "" || consumerSecret == "" || accessToken == "" || accessTokenSecret == "" {
		return nil, fmt.Errorf("TWITTER_CONSUMER_KEY, TWITTER_CONSUMER_SECRET, TWITTER_ACCESS_TOKEN or TWITTER_ACCESS_TOKEN_SECRET not set")
	}
